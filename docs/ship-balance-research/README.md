...
- [2026-09-20 space energy, propulsion, and lunar industrial timelines to 2100](space-energy-and-industrial-timelines-2026-2100.md), with [working primary-source notes and brief verbatim excerpts](details/space-energy-primary-source-notes-2026-09-20.md)
- [2026-09-11 fission-drive progression, changed tradeoffs, and scientific bounds](fission-drive-progression-and-scientific-bounds-2026-09-11.md), with [complete drive/reactor/unlock tables](fission-drive-data-tables-2026-09-11.md) and a [hashed data snapshot](tables/fission-drive-audit-2026-09-11.json)
- [2026-09-11 fusion magnet scaling, reactor size, and overlapping technology timelines](fusion-magnet-scaling-and-technology-timeline-2026-09-11.md)
- [2026-09-11 molten- and gas-core containment, temperatures, and demonstrated hardware](molten-and-gas-core-containment-and-demonstration-2026-09-11.md)
...
- [Open-cycle reactor mass scaling and power UI plan](open-cycle-reactor-mass-scaling-plan-2026-08-21.md)
- [NERVA-class thermal-reactor specific mass](details/reactors/nerva-thermal-specific-mass-2026-08-21.md)
