...
| `CohesionRestAutocracyPatch`, `CohesionRestAnocracyPatch`, `CohesionRestDemocracyPatch` | Regime-specific Cohesion effects | Aligned. Autocracy uses `(4^1.285 - Government^1.285) * (10-Unrest)/10` below 4.0. Anocracy starts at 4.0 and retains `2*abs(5-Government)-3` through 6.5. High Democracy uses `democracyCoefficient * (Government - 6.5)` with coefficient 1.0, and stops at Cohesion 5. |
