...
if ($assemblyVersion -ne '0.8.3.0') {
    throw "Assembly version '$assemblyVersion' does not match release 0.8.3."
}
...
$zipPath = Join-Path $artifactDirectory 'TIEconomyMod-0.8.3-ti1.0.51.zip'
