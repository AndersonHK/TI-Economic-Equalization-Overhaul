...
$expectedPower = [ordered]@{
    ...
    SolidCoreFissionReactorI = @(0.575, 240, 2, 480)
    SolidCoreFissionReactorII = @(0.60, 204, 3, 612)
    SolidCoreFissionReactorIII = @(0.625, 168, 10, 1680)
    SolidCoreFissionReactorIV = @(0.65, 72, 30, 2160)
    SolidCoreFissionReactorV = @(0.675, 48, 60, 2880)
    SolidCoreFissionReactorVI = @(0.60, 36, 0.75, 27)
    SolidCoreFissionReactorVII = @(0.625, 30, 2, 60)
    SolidCoreFissionReactorVIII = @(0.65, 24, 4, 96)
    SolidCoreFissionReactorIX = @(0.675, 18, 6, 108)
    SolidCoreFissionReactorX = @(0.70, 12, 10, 120)
    MoltenSaltFissionReactorI = @(0.725, 15, 40, 600)
    MoltenSaltFissionReactorII = @(0.75, 12, 400, 4800)
    ...
    VaporCoreFissionReactorI = @(0.87, 9, $null, $null)
    VaporCoreFissionReactorII = @(0.88, 8, $null, $null)
    VaporCoreFissionReactorIII = @(0.89, 7, $null, $null)
    ...
    GasCoreFissionReactorIV = @(0.92, 7, 1000, 7000)
    GasCoreFissionReactorV = @(0.93, 6, 1300, 7800)
    GasCoreFissionReactorVI = @(0.94, 5, 1700, 8500)
